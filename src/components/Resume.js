            ...
            <ResumeCard val={
                    {
                        ...
                        body: "I started a part-time occupation at AmiNIC, a tech start-up that is working on developing a sensor used to accurately determining the expiration date of meat and fish products in order to reduce waste. \n Particularly, I have been responsible for performing some experiments (data gathering) and partially analyse the results, giving a preliminary report to my supervisor. I also had the chance to set-up some experiments that I independently carried on. \n I also designed and 3D printed some fundamental parts, performed fluid-flow analysis, assembled and properly initialized devices and fixed some.",
